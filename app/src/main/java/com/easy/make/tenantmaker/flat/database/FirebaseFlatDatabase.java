package com.easy.make.tenantmaker.flat.database;
...
public class FirebaseFlatDatabase implements FlatDatabase {
    ...
    public Observable<Flats> observeFlatsFor(User user) {
        return firebaseObservableListeners.listenToValueEvents(flatDb.child(user.getId()).limitToFirst(DEFAULT_LIMIT), getFlats());
    }

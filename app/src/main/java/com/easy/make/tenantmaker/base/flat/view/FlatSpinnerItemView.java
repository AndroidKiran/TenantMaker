 ...
 */
public class FlatSpinnerItemView extends RelativeLayout {

    private int layoutResId;
    private AppCompatTextView flatName;
    private AppCompatTextView flatAddress;

    public FlatSpinnerItemView(Context context) {
        super(context);
    }

    public FlatSpinnerItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            layoutResId = array.getResourceId(0, R.layout.merge_spinner_flat_item);
            array.recycle();
        }
    }
